...
def nonempty_group_list(db, app):
...
def random_group(nonempty_group_list):
    return random.choice(nonempty_group_list)
...
def verify_group_deleted(db, nonempty_group_list, random_group, app, check_ui):
    old_groups = nonempty_group_list
    new_groups = db.get_group_list()
